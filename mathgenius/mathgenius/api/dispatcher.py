...
from mathgenius.algebra.equations import solve_linear, solve_quadratic, solve_equation as solve_equation_algebra, solve_cubic
...
__all__ = [
    ...
    # Algebra
    "solve_linear", "solve_quadratic", "solve_equation", "solve_cubic",
