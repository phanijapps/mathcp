#!/usr/bin/env python3
"""Test the equation solving functionality through the mathgenius API"""
...
from mathgenius.api.dispatcher import solve_equation, solve_cubic, solve_linear, solve_quadratic

def test_equation_solving():
    print("Testing Equation Solving Functions")
    print("=" * 50)
